...
function App() {
  // fetch data using useEffect hook and axios library.
    ...
    <div className='bg-zinc-300 h-screen'>
      <div className='flex justify-center items-center flex-wrap p-10 gap-10'>
       ...
       { data.length > 0 ? (
        ...
        <div className='w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 flex-shrink-0'>
          <a href="#">
